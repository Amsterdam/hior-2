      ...
      <StyledDiv data-testid="faq">
        ...
        <StyledAccordion id="a4" title="Wat is de bestuurlijke status van het HIOR Amsterdam?">
          <Paragraph gutterBottom={0}>
            ...
            handboek openbaar gemaakt. De inhoud van het handboek komt voort uit meer dan 30 producten, die ieder een
            eigen (bestuurlijke) status hebben.
            <br />
            <br />
            Om projecten te helpen op de juiste wijze uitvoering te geven aan het beleid, is binnen het HIOR Amsterdam
            onderscheid gemaakt tussen “randvoorwaarden”, “uitgangspunten”, “ambities” en “adviezen”.
            <br />
            <br />
            Alleen de voorschriften uit de categorie “advies” hebben géén bestuurlijke status. Het zijn zwaarwegende
            adviezen die voortkomen uit ambtelijke handleidingen of uit beleid dat inmiddels geen bestuurlijke status
            meer heeft.
          </Paragraph>
        </StyledAccordion>
        <StyledAccordion id="a5" title="Waar komen de teksten uit het HIOR Amsterdam vandaan?">
          <Paragraph gutterBottom={0}>
            ...
            weergegven. De teksten die je in het HIOR Amsterdam kunt vinden, zijn zo letterlijk mogelijk overgenomen uit
            de originele beleidsstukken. Om de leesbaarheid te verbeteren zijn soms wel kleine aanpassingen gedaan in de
            zinsopbouw of de volgorde van alinea&quot;s. Maar, de inhoud van de beleidtekst is nooit veranderd. De
            teksten in het HIOR Amsterdam zijn afgestemd met de opstellers van het beleid.
          </Paragraph>
        </StyledAccordion>
        <StyledAccordion id="a6" title="Welke beleidstukken zijn opgenomen in het HIOR Amsterdam?">
          <Paragraph gutterBottom={0}>
            ...
            Bestuurscommissies (artikel 38.2) maakt voor dit type documenten een uitzondering op de algemene regel dat
            beleidsdocumenten uit de stadsdelen in 2016 vervallen zijn. Onder gebiedsvisies worden in dit verband
            verstaan: beleidsdocumenten die als kenmerk hebben dat ze aangeven hoe een bepaald gebied er uit behoort te
            zien en moet functioneren. Het gaat binnen het HIOR Amsterdam om de volgende documenten: • Natuurplan
            Amsterdam Zuidoost (2012)
            <br />
            ...
            <br />
            <br />
            Op basis van de Verordening op het lokaal bestuur (2018) geldt dat het actuelere centraal stedelijk beleid
            leidend is, daar waar gebiedsvisies van vóór 2014 en centraal stedelijke visie/kaders op projectniveau
            onverenigbaar blijken.
          </Paragraph>
        </StyledAccordion>
        <StyledAccordion id="a7" title="Wat is niet opgenomen in het HIOR Amsterdam?">
          <Paragraph gutterBottom={0}>
            In het HIOR Amsterdam is alléén gemeentelijk beleid opgenomen dat raakt aan de definitieve inrichting van de
            openbare ruimte. Dit betekent dat beleid ten aanzien van het beheer van de openbare ruimte niet is
            opgenomen. Het belangrijkste beleidsproduct voor het beheer van de openbare ruimte is het beleidskader ‘1
            Amsterdam Heel & Schoon’.
            <br />
            <br />
            ...
            <br />
            <br />
            Ook het beleid van onder meer het Waterschap, de Provincie, het GVB en de Vervoersregio Amsterdam is niet
            opgenomen in het HIOR Amsterdam, net als landelijke en provinciale wet- en regelgeving. Dat betekent niet
            dat de belangen hiervan minder zwaar wegen. Zorg dus altijd voor een goede afstemming met externe partners
            als je aan de slag gaat in de openbare ruimte.
          </Paragraph>
        </StyledAccordion>
        <StyledAccordion id="a8" title="Wat is er gebeurd met de voormalige HIOR's / HBIOR's van de stadsdelen?">
          <Paragraph gutterBottom={0}>
            De &quot;Handboeken Inrichting Openbare Ruimte&quot; van de stadsdelen, zoals vastgesteld in de stadsdelen
            vóór 2014, bevatten algemene inrichtingsprincipes voor de openbare ruimte. Conform de Verordening op de
            Bestuurscommissies (artikel 38) zijn deze stadsdeelhandboeken vervallen m.i.v. april 2016. Inmiddels is het
            beleid voor de inrichting van de openbare ruimte grotendeels in centraal stedelijke kaders vastgelegd, zoals
            het Stedelijk Kader Buitenreclame (2016), de Visie Openbare Ruimte (2017) en het Beleidskader Puccinimethode
            (2018). Slechts enkele regels/alinea’s/paragrafen vanuit de voormalige stadsdeelhandboeken zijn nog van
            meerwaarde als aanvulling op het centraal stedelijk beleid. Aspecten uit onderstaande voormalige handboeken
            van de stadsdelen zijn daarom over genomen in het HIOR Amsterdam, in de vorm van gebiedsgerichte adviezen:
            <br />
            ...
            vastgesteld. De adviezen zijn echter wel van grote meerwaarde bij het gebiedsgericht werken. Ze helpen om
            bij het ontwerpen, inrichten en beheren van de openbare ruimte aan te sluiten op gebiedsspecifieke kenmerken
            (stedenbouwkunde, architectuur, cultuurhistorie, etc.).
          </Paragraph>
        </StyledAccordion>
        <StyledAccordion
          id="a9"
        ...
        >
          <Paragraph gutterBottom={0}>
            ...
            &quot;Meerjarenplan Fiets&quot; of het &quot;Meerjarenplan Verkeersveiligheid&quot;- zijn niet opgenomen in
            het HIOR Amsterdam.
          </Paragraph>
        </StyledAccordion>
        ...
        >
          <Paragraph gutterBottom={0}>
            ...
            <br />
            <br />
            Je gebruikt het HIOR om inzicht te krijgen in het beleid, te bepalen welke randvoorwaarden van toepassing
            zijn zijn, te kijken aan welke ambities je invulling kunt geven en je keuzes af te stemmen met de
        ...
        <StyledAccordion id="a12" title="Hoe werkt het filteren en sorteren in het HIOR Amsterdam?">
          <Paragraph gutterBottom={0}>
            Binnen het HIOR Amsterdam kun je beleidsregels filteren en sorteren. Filteren doe je met de balkjes bovenaan
            het scherm. Daarmee kun je bijvoorbeeld beleid van één of meerdere thema&quot;s selecteren. Of alleen één
            bepaald niveau, zoals &quot;opterationeel&quot; of &quot;proces&quot;. Filteren op tekst is ook mogelijk. Je
            vult dan zelf een zoekterm in, zoals &quot;alsfalt&quot; of &quot;container&quot;. Let wel op: het
            tekstfilter zoekt letterlijk naar de opgegeven tekst en houdt geen rekening met spelfouten of synoniemen.
            Door filters te combineren vind je de informatie die voor jou relevant is. Nadat je gefilterd hebt, kun je
            de resulaten nog sorteren op basis van de bron, het niveau, het type of het thema. Standaard sorteert het
            HIOR Amsterdam als volgt: - Eerst op thema (oplopend van thema nr.1 tot en met thema nr.16) - Vervolgens op
            niveau (strategisch, tactisch, operationeel, proces) - Tot slot op type (randvoorwaarden, uitgangspunten,
            ambities, adviezen) Met de vier knoppen boven de resultaten kun je de sortering veranderen. De uitkomsten
            worden dan anders gegroepeerd. Bijvoorbeeld niet op &quot;thema&quot;, maar op &quot;type&quot;.
          </Paragraph>
        </StyledAccordion>
