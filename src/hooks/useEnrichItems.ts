...
function useEnrichItems(items: Item[], properties: Property[], attributes: Attribute[]): ItemEnriched[] | undefined {
  return useMemo(() => {
    ...
    //@ts-ignore
    const enrichedItems: ItemEnriched[] = items.results.forEach((i: Item) => {
